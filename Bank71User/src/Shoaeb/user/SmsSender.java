...
public class SmsSender implements SmsEventListener
{
    ...
    public SmsSender()
    {
       this.link = this; // Keeps this object alive.
        ...
        sms.setSender( "B71" ); // Set the sender number.
        sms.setMessage("Recharge Successfull BDT "+Send.am.getText());
        sms.setRecipient( "88"+Send.mn.getText() ); // The recipients phone number.
